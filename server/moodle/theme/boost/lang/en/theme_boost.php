...
// Modern UI Settings
$string['modernsettings'] = 'Modern UI Settings';
$string['enablemodern'] = 'Enable Modern UI';
$string['enablemodern_desc'] = 'Enable the modern UI enhancements including gradients, animations, and improved styling.';
$string['herotitle'] = 'Hero Section Title';
$string['herotitle_desc'] = 'The main title displayed in the hero section of the homepage.';
$string['herosubtitle'] = 'Hero Section Subtitle';
$string['herosubtitle_desc'] = 'The subtitle text displayed below the main title in the hero section.';
$string['gradientcolor1'] = 'Primary Gradient Color 1';
$string['gradientcolor1_desc'] = 'The first color in the primary gradient used throughout the modern theme.';
$string['gradientcolor2'] = 'Primary Gradient Color 2';
$string['gradientcolor2_desc'] = 'The second color in the primary gradient used throughout the modern theme.';
$string['enableanimations'] = 'Enable Animations';
$string['enableanimations_desc'] = 'Enable smooth animations and hover effects throughout the site for a more interactive experience.';
